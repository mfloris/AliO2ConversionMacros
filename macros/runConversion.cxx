...
const TString localAODFile("./AliAOD.root");
enum Mode { Local, Grid, TestGrid, Terminate };

/// Short runConversion description
///
/// More detailed runConversion description
/// \param mode Short description of mode
