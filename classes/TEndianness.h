...
// taken from http://stackoverflow.com/a/3522853/6019199
...
template <> struct swap_bytes<float, 4> {
...
template <> struct swap_bytes<double, 8> {
...
template <endianness from, endianness to, class T> struct do_byte_swap {
...
inline T convertEndianess(T value) {
