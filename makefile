...
CPP_FLAGS := $(shell root-config --cflags) -fPIC -g -fno-omit-frame-pointer -O2 -pipe -march=native -I $(CLASS_DIR) -I $(COMMON_MACRO_DIR) -I $$ALICE_ROOT/include -I $$ALICE_PHYSICS/include
LD_FLAGS := -lESD -lEG -lGeom -lMinuit -lVMC -lXMLParser -lTreePlayer -lXMLIO -lSTEERBase -lANALYSIS -lAOD -lANALYSISalice -lANALYSISaliceBase -lO2
